...
int main(int argc, char* argv[])
{
	...
	SDL_Texture* sdlTexture = SDL_CreateTexture(sdlRenderer,pixformat, SDL_TEXTUREACCESS_STREAMING,pixel_w,pixel_h);//创建纹理
	...
	while(1){
			...
			SDL_RenderCopy( sdlRenderer, sdlTexture, NULL, &sdlRect);//纹理数据拷贝给渲染器  
